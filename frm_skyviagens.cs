...
{
    public partial class frm_skyviagens : Form
    {
        public frm_skyviagens()
        {
            InitializeComponent();
        }
        ...
        private void frm_skyviagens_Paint(object sender, PaintEventArgs e)
        {

        }

        private void frm_skyviagens_Load(object sender, EventArgs e)
        {
        ...
        private void pictureBox17_Paint(object sender, PaintEventArgs e)
        {
            ...
            Rectangle sombra = new Rectangle(0, 0, 10, pic.Height); // largura da sombra
            using (LinearGradientBrush brush = new LinearGradientBrush(sombra, Color.Black, Color.Transparent, 0f))
            {
                g.FillRectangle(brush, sombra);
            }
        }
